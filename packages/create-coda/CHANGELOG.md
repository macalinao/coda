...
- 4ea13cf: Bump the scaffolded project's linter pins to oxlint 1.82.0 and oxlint-tsgolint 7.0.2001, matching the toolchain the Coda monorepo now uses.
...
- 0efb34f: Scaffolded projects now pin `oxlint` 1.80.0 (up from 1.73.0), matching the version
  the Coda monorepo lints with.
