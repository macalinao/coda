...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm create @macalinao/create-coda@latest my-project
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn create @macalinao/create-coda my-project
    ```
  </Tab>
  <Tab value="bun">
    ```bash
...
Create a new Coda client project with your preferred package manager:
...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm create @macalinao/create-coda@latest my-awesome-dex
    pnpm create @macalinao/create-coda@latest lending-protocol
    pnpm create @macalinao/create-coda@latest nft-marketplace
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn create @macalinao/create-coda my-awesome-dex
    yarn create @macalinao/create-coda lending-protocol
    yarn create @macalinao/create-coda nft-marketplace
    ```
  </Tab>
  <Tab value="bun">
    ```bash
