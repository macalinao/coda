...
Documentation is crucial for Solana program adoption. This renderer automatically generates:

- **Complete API documentation** from your IDL
- **Structured markdown** ready for documentation sites
- **TypeScript-style definitions** for clarity
- **Cross-referenced links** between related components
- **Tables and formatted output** for better readability
...
This renderer integrates seamlessly with Coda's `generate-docs` command:
