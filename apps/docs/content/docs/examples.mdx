...
[![npm version](https://img.shields.io/npm/v/@solana-programs/token-metadata.svg?style=flat-square)](https://www.npmjs.com/package/@solana-programs/token-metadata)
[![npm downloads](https://img.shields.io/npm/dm/@solana-programs/token-metadata.svg?style=flat-square)](https://www.npmjs.com/package/@solana-programs/token-metadata)
...
- **Single IDL configuration** - Simple `coda.config.ts` for one program
...
[![npm version](https://img.shields.io/npm/v/@solana-programs/quarry.svg?style=flat-square)](https://www.npmjs.com/package/@solana-programs/quarry)
[![npm downloads](https://img.shields.io/npm/dm/@solana-programs/quarry.svg?style=flat-square)](https://www.npmjs.com/package/@solana-programs/quarry)
...
[![npm version](https://img.shields.io/npm/v/@solana-programs/kamino-lending.svg?style=flat-square)](https://www.npmjs.com/package/@solana-programs/kamino-lending)
[![npm downloads](https://img.shields.io/npm/dm/@solana-programs/kamino-lending.svg?style=flat-square)](https://www.npmjs.com/package/@solana-programs/kamino-lending)
