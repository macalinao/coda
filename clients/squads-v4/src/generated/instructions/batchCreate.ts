...
export function getBatchCreateInstructionDataDecoder(): Decoder<BatchCreateInstructionData> {
  return getStructDecoder([
    ...
    ["args", getBatchCreateArgsDecoder()],
  ]);
}
...
> = {
  ...
  args: BatchCreateInstructionDataArgs["args"];
};
