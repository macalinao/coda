...
export const VAULT_TRANSACTION_EXECUTE_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([194, 8, 161, 87, 153, 164, 25, 171]);

export function getVaultTransactionExecuteDiscriminatorBytes(): ReadonlyUint8Array {
