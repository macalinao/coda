...
export function getCollectRewardDiscriminatorBytes(): ReadonlyUint8Array {
...
export interface CollectRewardInstructionData {
  discriminator: ReadonlyUint8Array;
  rewardIndex: number;
}

export interface CollectRewardInstructionDataArgs { rewardIndex: number }
...
export interface CollectRewardInput<
...
export interface ParsedCollectRewardInstruction<
  TProgram extends string = typeof WHIRLPOOL_PROGRAM_ADDRESS,
