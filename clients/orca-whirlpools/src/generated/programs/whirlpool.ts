...
import {
  ...
  type SetConfigExtensionAuthorityInput,
  type SetDefaultFeeRateInput,
  type SetDefaultProtocolFeeRateInput,
  type SetFeeAuthorityInput,
  type SetFeeRateInput,
  type SetProtocolFeeRateInput,
  type SetRewardAuthorityBySuperAuthorityInput,
  type SetRewardAuthorityInput,
  type SetRewardEmissionsInput,
  type SetRewardEmissionsSuperAuthorityInput,
  type SetRewardEmissionsV2Input,
  type SetTokenBadgeAuthorityInput,
  type SwapInput,
  type SwapV2Input,
...
export type WhirlpoolPlugin = {
  accounts: WhirlpoolPluginAccounts;
  instructions: WhirlpoolPluginInstructions;
  identifyAccount: typeof identifyWhirlpoolAccount;
  identifyInstruction: typeof identifyWhirlpoolInstruction;
  parseInstruction: typeof parseWhirlpoolInstruction;
};

export type WhirlpoolPluginAccounts = {
...
export type WhirlpoolPluginInstructions = {
  initializeConfig: (
