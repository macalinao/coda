...
export interface SetRateSetterInstructionData {
...
export function getSetRateSetterInstructionDataEncoder(): FixedSizeEncoder<SetRateSetterInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: SET_RATE_SETTER_DISCRIMINATOR }),
  );
}

export function getSetRateSetterInstructionDataDecoder(): FixedSizeDecoder<SetRateSetterInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getSetRateSetterInstructionDataCodec(): FixedSizeCodec<
...
export interface SetRateSetterInput<
...
export function getSetRateSetterInstruction<
  TAccountOperator extends string,
  TAccountAdmin extends string,
  TAccountDelegate extends string,
  TProgramAddress extends Address = typeof QUARRY_OPERATOR_PROGRAM_ADDRESS,
>(
  input: SetRateSetterInput<TAccountOperator, TAccountAdmin, TAccountDelegate>,
...
export interface ParsedSetRateSetterInstruction<
  TProgram extends string = typeof QUARRY_OPERATOR_PROGRAM_ADDRESS,
...
> {
  ...
  data: SetRateSetterInstructionData;
}

export function parseSetRateSetterInstruction<
...
>(
  ...
  return {
    ...
    data: getSetRateSetterInstructionDataDecoder().decode(instruction.data),
  };
}
