...
export const DELEGATE_CREATE_QUARRY_DISCRIMINATOR = new Uint8Array([
  245, 238, 31, 14, 175, 233, 75, 237,
]);
...
export interface DelegateCreateQuarryInstructionDataArgs { bump: number }
