...
/** Gets the encoder for {@link SignatoryRecordV2Args} account data. */
...
/** Gets the decoder for {@link SignatoryRecordV2} account data. */
...
/** Gets the codec for {@link SignatoryRecordV2} account data. */
