...
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_RATE = 0x17_70; // 6000
/** RatesFull:  */
export const VOTER_STAKE_REGISTRY_ERROR__RATES_FULL = 0x17_71; // 6001
/** VotingMintNotFound:  */
export const VOTER_STAKE_REGISTRY_ERROR__VOTING_MINT_NOT_FOUND = 0x17_72; // 6002
/** DepositEntryNotFound:  */
export const VOTER_STAKE_REGISTRY_ERROR__DEPOSIT_ENTRY_NOT_FOUND = 0x17_73; // 6003
/** DepositEntryFull:  */
export const VOTER_STAKE_REGISTRY_ERROR__DEPOSIT_ENTRY_FULL = 0x17_74; // 6004
/** VotingTokenNonZero:  */
export const VOTER_STAKE_REGISTRY_ERROR__VOTING_TOKEN_NON_ZERO = 0x17_75; // 6005
/** OutOfBoundsDepositEntryIndex:  */
export const VOTER_STAKE_REGISTRY_ERROR__OUT_OF_BOUNDS_DEPOSIT_ENTRY_INDEX = 0x17_76; // 6006
/** UnusedDepositEntryIndex:  */
export const VOTER_STAKE_REGISTRY_ERROR__UNUSED_DEPOSIT_ENTRY_INDEX = 0x17_77; // 6007
/** InsufficientUnlockedTokens:  */
export const VOTER_STAKE_REGISTRY_ERROR__INSUFFICIENT_UNLOCKED_TOKENS = 0x17_78; // 6008
/** UnableToConvert:  */
export const VOTER_STAKE_REGISTRY_ERROR__UNABLE_TO_CONVERT = 0x17_79; // 6009
/** InvalidLockupPeriod:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_LOCKUP_PERIOD = 0x17_7a; // 6010
/** InvalidEndTs:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_END_TS = 0x17_7b; // 6011
/** InvalidDays:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_DAYS = 0x17_7c; // 6012
/** VotingMintConfigIndexAlreadyInUse:  */
export const VOTER_STAKE_REGISTRY_ERROR__VOTING_MINT_CONFIG_INDEX_ALREADY_IN_USE = 0x17_7d; // 6013
/** OutOfBoundsVotingMintConfigIndex:  */
export const VOTER_STAKE_REGISTRY_ERROR__OUT_OF_BOUNDS_VOTING_MINT_CONFIG_INDEX = 0x17_7e; // 6014
/** InvalidDecimals: Exchange rate decimals cannot be larger than registrar decimals */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_DECIMALS = 0x17_7f; // 6015
/** InvalidToDepositAndWithdrawInOneSlot:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_TO_DEPOSIT_AND_WITHDRAW_IN_ONE_SLOT = 0x17_80; // 6016
/** ShouldBeTheFirstIxInATx:  */
export const VOTER_STAKE_REGISTRY_ERROR__SHOULD_BE_THE_FIRST_IX_IN_A_TX = 0x17_81; // 6017
/** ForbiddenCpi:  */
export const VOTER_STAKE_REGISTRY_ERROR__FORBIDDEN_CPI = 0x17_82; // 6018
/** InvalidMint:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_MINT = 0x17_83; // 6019
/** DebugInstruction:  */
export const VOTER_STAKE_REGISTRY_ERROR__DEBUG_INSTRUCTION = 0x17_84; // 6020
/** ClawbackNotAllowedOnDeposit:  */
export const VOTER_STAKE_REGISTRY_ERROR__CLAWBACK_NOT_ALLOWED_ON_DEPOSIT = 0x17_85; // 6021
/** DepositStillLocked:  */
export const VOTER_STAKE_REGISTRY_ERROR__DEPOSIT_STILL_LOCKED = 0x17_86; // 6022
/** InvalidAuthority:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_AUTHORITY = 0x17_87; // 6023
/** InvalidTokenOwnerRecord:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_TOKEN_OWNER_RECORD = 0x17_88; // 6024
/** InvalidRealmAuthority:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_REALM_AUTHORITY = 0x17_89; // 6025
/** VoterWeightOverflow:  */
export const VOTER_STAKE_REGISTRY_ERROR__VOTER_WEIGHT_OVERFLOW = 0x17_8a; // 6026
/** LockupSaturationMustBePositive:  */
export const VOTER_STAKE_REGISTRY_ERROR__LOCKUP_SATURATION_MUST_BE_POSITIVE = 0x17_8b; // 6027
/** VotingMintConfiguredWithDifferentIndex:  */
export const VOTER_STAKE_REGISTRY_ERROR__VOTING_MINT_CONFIGURED_WITH_DIFFERENT_INDEX = 0x17_8c; // 6028
/** InternalProgramError:  */
export const VOTER_STAKE_REGISTRY_ERROR__INTERNAL_PROGRAM_ERROR = 0x17_8d; // 6029
/** InsufficientLockedTokens:  */
export const VOTER_STAKE_REGISTRY_ERROR__INSUFFICIENT_LOCKED_TOKENS = 0x17_8e; // 6030
/** MustKeepTokensLocked:  */
export const VOTER_STAKE_REGISTRY_ERROR__MUST_KEEP_TOKENS_LOCKED = 0x17_8f; // 6031
/** InvalidLockupKind:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_LOCKUP_KIND = 0x17_90; // 6032
/** InvalidChangeToClawbackDepositEntry:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_CHANGE_TO_CLAWBACK_DEPOSIT_ENTRY = 0x17_91; // 6033
/** InternalErrorBadLockupVoteWeight:  */
export const VOTER_STAKE_REGISTRY_ERROR__INTERNAL_ERROR_BAD_LOCKUP_VOTE_WEIGHT = 0x17_92; // 6034
/** DepositStartTooFarInFuture:  */
export const VOTER_STAKE_REGISTRY_ERROR__DEPOSIT_START_TOO_FAR_IN_FUTURE = 0x17_93; // 6035
/** VaultTokenNonZero:  */
export const VOTER_STAKE_REGISTRY_ERROR__VAULT_TOKEN_NON_ZERO = 0x17_94; // 6036
/** InvalidTimestampArguments:  */
export const VOTER_STAKE_REGISTRY_ERROR__INVALID_TIMESTAMP_ARGUMENTS = 0x17_95; // 6037
