...
if (process.env["NODE_ENV"] !== "production") {
  voterStakeRegistryErrorMessages = {
    ...
    [VOTER_STAKE_REGISTRY_ERROR__INVALID_DECIMALS]: `Exchange rate decimals cannot be larger than registrar decimals`,
    ...
    [VOTER_STAKE_REGISTRY_ERROR__INVALID_RATE]: `Exchange rate must be greater than zero`,
...
export function getVoterStakeRegistryErrorMessage(
  ...
  if (process.env["NODE_ENV"] !== "production") {
    return (
      voterStakeRegistryErrorMessages as Record<VoterStakeRegistryError, string>
    )[code];
  }
