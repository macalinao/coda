...
export const KAMINO_LENDING_ERROR__INVALID_MARKET_AUTHORITY = 0x17_70; // 6000
/** InvalidMarketOwner: Market owner is invalid */
export const KAMINO_LENDING_ERROR__INVALID_MARKET_OWNER = 0x17_71; // 6001
/** InvalidAccountOwner: Input account owner is not the program address */
export const KAMINO_LENDING_ERROR__INVALID_ACCOUNT_OWNER = 0x17_72; // 6002
/** InvalidAmount: Input amount is invalid */
export const KAMINO_LENDING_ERROR__INVALID_AMOUNT = 0x17_73; // 6003
/** InvalidConfig: Input config value is invalid */
export const KAMINO_LENDING_ERROR__INVALID_CONFIG = 0x17_74; // 6004
/** InvalidSigner: Input account must be a signer */
export const KAMINO_LENDING_ERROR__INVALID_SIGNER = 0x17_75; // 6005
/** InvalidAccountInput: Invalid account input */
export const KAMINO_LENDING_ERROR__INVALID_ACCOUNT_INPUT = 0x17_76; // 6006
/** MathOverflow: Math operation overflow */
export const KAMINO_LENDING_ERROR__MATH_OVERFLOW = 0x17_77; // 6007
/** InsufficientLiquidity: Insufficient liquidity available */
export const KAMINO_LENDING_ERROR__INSUFFICIENT_LIQUIDITY = 0x17_78; // 6008
/** ReserveStale: Reserve state needs to be refreshed */
export const KAMINO_LENDING_ERROR__RESERVE_STALE = 0x17_79; // 6009
/** WithdrawTooSmall: Withdraw amount too small */
export const KAMINO_LENDING_ERROR__WITHDRAW_TOO_SMALL = 0x17_7a; // 6010
/** WithdrawTooLarge: Withdraw amount too large */
export const KAMINO_LENDING_ERROR__WITHDRAW_TOO_LARGE = 0x17_7b; // 6011
/** BorrowTooSmall: Borrow amount too small to receive liquidity after fees */
export const KAMINO_LENDING_ERROR__BORROW_TOO_SMALL = 0x17_7c; // 6012
/** BorrowTooLarge: Borrow amount too large for deposited collateral */
export const KAMINO_LENDING_ERROR__BORROW_TOO_LARGE = 0x17_7d; // 6013
/** RepayTooSmall: Repay amount too small to transfer liquidity */
export const KAMINO_LENDING_ERROR__REPAY_TOO_SMALL = 0x17_7e; // 6014
/** LiquidationTooSmall: Liquidation amount too small to receive collateral */
export const KAMINO_LENDING_ERROR__LIQUIDATION_TOO_SMALL = 0x17_7f; // 6015
/** ObligationHealthy: Cannot liquidate healthy obligations */
export const KAMINO_LENDING_ERROR__OBLIGATION_HEALTHY = 0x17_80; // 6016
/** ObligationStale: Obligation state needs to be refreshed */
export const KAMINO_LENDING_ERROR__OBLIGATION_STALE = 0x17_81; // 6017
/** ObligationReserveLimit: Obligation reserve limit exceeded */
export const KAMINO_LENDING_ERROR__OBLIGATION_RESERVE_LIMIT = 0x17_82; // 6018
/** InvalidObligationOwner: Obligation owner is invalid */
export const KAMINO_LENDING_ERROR__INVALID_OBLIGATION_OWNER = 0x17_83; // 6019
/** ObligationDepositsEmpty: Obligation deposits are empty */
export const KAMINO_LENDING_ERROR__OBLIGATION_DEPOSITS_EMPTY = 0x17_84; // 6020
/** ObligationBorrowsEmpty: Obligation borrows are empty */
export const KAMINO_LENDING_ERROR__OBLIGATION_BORROWS_EMPTY = 0x17_85; // 6021
/** ObligationDepositsZero: Obligation deposits have zero value */
export const KAMINO_LENDING_ERROR__OBLIGATION_DEPOSITS_ZERO = 0x17_86; // 6022
/** ObligationBorrowsZero: Obligation borrows have zero value */
export const KAMINO_LENDING_ERROR__OBLIGATION_BORROWS_ZERO = 0x17_87; // 6023
/** InvalidObligationCollateral: Invalid obligation collateral */
export const KAMINO_LENDING_ERROR__INVALID_OBLIGATION_COLLATERAL = 0x17_88; // 6024
/** InvalidObligationLiquidity: Invalid obligation liquidity */
export const KAMINO_LENDING_ERROR__INVALID_OBLIGATION_LIQUIDITY = 0x17_89; // 6025
/** ObligationCollateralEmpty: Obligation collateral is empty */
export const KAMINO_LENDING_ERROR__OBLIGATION_COLLATERAL_EMPTY = 0x17_8a; // 6026
/** ObligationLiquidityEmpty: Obligation liquidity is empty */
export const KAMINO_LENDING_ERROR__OBLIGATION_LIQUIDITY_EMPTY = 0x17_8b; // 6027
/** NegativeInterestRate: Interest rate is negative */
export const KAMINO_LENDING_ERROR__NEGATIVE_INTEREST_RATE = 0x17_8c; // 6028
/** InvalidOracleConfig: Input oracle config is invalid */
export const KAMINO_LENDING_ERROR__INVALID_ORACLE_CONFIG = 0x17_8d; // 6029
/** InsufficientProtocolFeesToRedeem: Insufficient protocol fees to claim or no liquidity available */
export const KAMINO_LENDING_ERROR__INSUFFICIENT_PROTOCOL_FEES_TO_REDEEM = 0x17_8e; // 6030
/** FlashBorrowCpi: No cpi flash borrows allowed */
export const KAMINO_LENDING_ERROR__FLASH_BORROW_CPI = 0x17_8f; // 6031
/** NoFlashRepayFound: No corresponding repay found for flash borrow */
export const KAMINO_LENDING_ERROR__NO_FLASH_REPAY_FOUND = 0x17_90; // 6032
/** InvalidFlashRepay: Invalid repay found */
export const KAMINO_LENDING_ERROR__INVALID_FLASH_REPAY = 0x17_91; // 6033
/** FlashRepayCpi: No cpi flash repays allowed */
export const KAMINO_LENDING_ERROR__FLASH_REPAY_CPI = 0x17_92; // 6034
/** MultipleFlashBorrows: Multiple flash borrows not allowed in the same transaction */
export const KAMINO_LENDING_ERROR__MULTIPLE_FLASH_BORROWS = 0x17_93; // 6035
/** FlashLoansDisabled: Flash loans are disabled for this reserve */
export const KAMINO_LENDING_ERROR__FLASH_LOANS_DISABLED = 0x17_94; // 6036
/** SwitchboardV2Error: Switchboard error */
export const KAMINO_LENDING_ERROR__SWITCHBOARD_V2_ERROR = 0x17_95; // 6037
/** CouldNotDeserializeScope: Cannot deserialize the scope price account */
export const KAMINO_LENDING_ERROR__COULD_NOT_DESERIALIZE_SCOPE = 0x17_96; // 6038
/** PriceTooOld: Price too old */
export const KAMINO_LENDING_ERROR__PRICE_TOO_OLD = 0x17_97; // 6039
/** PriceTooDivergentFromTwap: Price too divergent from twap */
export const KAMINO_LENDING_ERROR__PRICE_TOO_DIVERGENT_FROM_TWAP = 0x17_98; // 6040
/** InvalidTwapPrice: Invalid twap price */
export const KAMINO_LENDING_ERROR__INVALID_TWAP_PRICE = 0x17_99; // 6041
/** GlobalEmergencyMode: Emergency mode is enabled */
export const KAMINO_LENDING_ERROR__GLOBAL_EMERGENCY_MODE = 0x17_9a; // 6042
/** InvalidFlag: Invalid lending market config */
export const KAMINO_LENDING_ERROR__INVALID_FLAG = 0x17_9b; // 6043
/** PriceNotValid: Price is not valid */
export const KAMINO_LENDING_ERROR__PRICE_NOT_VALID = 0x17_9c; // 6044
/** PriceIsBiggerThanHeuristic: Price is bigger than allowed by heuristic */
export const KAMINO_LENDING_ERROR__PRICE_IS_BIGGER_THAN_HEURISTIC = 0x17_9d; // 6045
/** PriceIsLowerThanHeuristic: Price lower than allowed by heuristic */
export const KAMINO_LENDING_ERROR__PRICE_IS_LOWER_THAN_HEURISTIC = 0x17_9e; // 6046
/** PriceIsZero: Price is zero */
export const KAMINO_LENDING_ERROR__PRICE_IS_ZERO = 0x17_9f; // 6047
/** PriceConfidenceTooWide: Price confidence too wide */
export const KAMINO_LENDING_ERROR__PRICE_CONFIDENCE_TOO_WIDE = 0x17_a0; // 6048
/** IntegerOverflow: Conversion between integers failed */
export const KAMINO_LENDING_ERROR__INTEGER_OVERFLOW = 0x17_a1; // 6049
/** NoFarmForReserve: This reserve does not have a farm */
export const KAMINO_LENDING_ERROR__NO_FARM_FOR_RESERVE = 0x17_a2; // 6050
/** IncorrectInstructionInPosition: Wrong instruction at expected position */
export const KAMINO_LENDING_ERROR__INCORRECT_INSTRUCTION_IN_POSITION = 0x17_a3; // 6051
/** NoPriceFound: No price found */
export const KAMINO_LENDING_ERROR__NO_PRICE_FOUND = 0x17_a4; // 6052
/** InvalidTwapConfig: Invalid Twap configuration: Twap is enabled but one of the enabled price doesn't have a twap */
export const KAMINO_LENDING_ERROR__INVALID_TWAP_CONFIG = 0x17_a5; // 6053
/** InvalidPythPriceAccount: Pyth price account does not match configuration */
export const KAMINO_LENDING_ERROR__INVALID_PYTH_PRICE_ACCOUNT = 0x17_a6; // 6054
/** InvalidSwitchboardAccount: Switchboard account(s) do not match configuration */
export const KAMINO_LENDING_ERROR__INVALID_SWITCHBOARD_ACCOUNT = 0x17_a7; // 6055
/** InvalidScopePriceAccount: Scope price account does not match configuration */
export const KAMINO_LENDING_ERROR__INVALID_SCOPE_PRICE_ACCOUNT = 0x17_a8; // 6056
...
export const KAMINO_LENDING_ERROR__OBLIGATION_COLLATERAL_LTV_ZERO = 0x17_a9; // 6057
/** InvalidObligationSeedsValue: Seeds must be default pubkeys for tag 0, and mint addresses for tag 1 or 2 */
export const KAMINO_LENDING_ERROR__INVALID_OBLIGATION_SEEDS_VALUE = 0x17_aa; // 6058
/** DeprecatedInvalidObligationId: [DEPRECATED] Obligation id must be 0 */
export const KAMINO_LENDING_ERROR__DEPRECATED_INVALID_OBLIGATION_ID = 0x17_ab; // 6059
/** InvalidBorrowRateCurvePoint: Invalid borrow rate curve point */
export const KAMINO_LENDING_ERROR__INVALID_BORROW_RATE_CURVE_POINT = 0x17_ac; // 6060
/** InvalidUtilizationRate: Invalid utilization rate */
export const KAMINO_LENDING_ERROR__INVALID_UTILIZATION_RATE = 0x17_ad; // 6061
/** CannotSocializeObligationWithCollateral: Obligation hasn't been fully liquidated and debt cannot be socialized. */
export const KAMINO_LENDING_ERROR__CANNOT_SOCIALIZE_OBLIGATION_WITH_COLLATERAL = 0x17_ae; // 6062
/** ObligationEmpty: Obligation has no borrows or deposits. */
export const KAMINO_LENDING_ERROR__OBLIGATION_EMPTY = 0x17_af; // 6063
/** WithdrawalCapReached: Withdrawal cap is reached */
export const KAMINO_LENDING_ERROR__WITHDRAWAL_CAP_REACHED = 0x17_b0; // 6064
/** LastTimestampGreaterThanCurrent: The last interval start timestamp is greater than the current timestamp */
export const KAMINO_LENDING_ERROR__LAST_TIMESTAMP_GREATER_THAN_CURRENT = 0x17_b1; // 6065
/** LiquidationRewardTooSmall: The reward amount is less than the minimum acceptable received liquidity */
export const KAMINO_LENDING_ERROR__LIQUIDATION_REWARD_TOO_SMALL = 0x17_b2; // 6066
/** IsolatedAssetTierViolation: Isolated Asset Tier Violation */
export const KAMINO_LENDING_ERROR__ISOLATED_ASSET_TIER_VIOLATION = 0x17_b3; // 6067
/** InconsistentElevationGroup: The obligation's elevation group and the reserve's are not the same */
export const KAMINO_LENDING_ERROR__INCONSISTENT_ELEVATION_GROUP = 0x17_b4; // 6068
/** InvalidElevationGroup: The elevation group chosen for the reserve does not exist in the lending market */
export const KAMINO_LENDING_ERROR__INVALID_ELEVATION_GROUP = 0x17_b5; // 6069
/** InvalidElevationGroupConfig: The elevation group updated has wrong parameters set */
export const KAMINO_LENDING_ERROR__INVALID_ELEVATION_GROUP_CONFIG = 0x17_b6; // 6070
...
export const KAMINO_LENDING_ERROR__UNHEALTHY_ELEVATION_GROUP_LTV = 0x17_b7; // 6071
/** ElevationGroupNewLoansDisabled: Elevation group does not accept any new loans or any new borrows/withdrawals */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_NEW_LOANS_DISABLED = 0x17_b8; // 6072
/** ReserveDeprecated: Reserve was deprecated, no longer usable */
export const KAMINO_LENDING_ERROR__RESERVE_DEPRECATED = 0x17_b9; // 6073
/** ReferrerAccountNotInitialized: Referrer account not initialized */
export const KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_NOT_INITIALIZED = 0x17_ba; // 6074
/** ReferrerAccountMintMissmatch: Referrer account mint does not match the operation reserve mint */
export const KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_MINT_MISSMATCH = 0x17_bb; // 6075
/** ReferrerAccountWrongAddress: Referrer account address is not a valid program address */
export const KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_WRONG_ADDRESS = 0x17_bc; // 6076
/** ReferrerAccountReferrerMissmatch: Referrer account referrer does not match the owner referrer */
export const KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_REFERRER_MISSMATCH = 0x17_bd; // 6077
/** ReferrerAccountMissing: Referrer account missing for obligation with referrer */
export const KAMINO_LENDING_ERROR__REFERRER_ACCOUNT_MISSING = 0x17_be; // 6078
/** InsufficientReferralFeesToRedeem: Insufficient referral fees to claim or no liquidity available */
export const KAMINO_LENDING_ERROR__INSUFFICIENT_REFERRAL_FEES_TO_REDEEM = 0x17_bf; // 6079
/** CpiDisabled: CPI disabled for this instruction */
export const KAMINO_LENDING_ERROR__CPI_DISABLED = 0x17_c0; // 6080
/** ShortUrlNotAsciiAlphanumeric: Referrer short_url is not ascii alphanumeric */
export const KAMINO_LENDING_ERROR__SHORT_URL_NOT_ASCII_ALPHANUMERIC = 0x17_c1; // 6081
/** ReserveObsolete: Reserve is marked as obsolete */
export const KAMINO_LENDING_ERROR__RESERVE_OBSOLETE = 0x17_c2; // 6082
/** ElevationGroupAlreadyActivated: Obligation already part of the same elevation group */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_ALREADY_ACTIVATED = 0x17_c3; // 6083
/** ObligationInObsoleteReserve: Obligation has a deposit or borrow in an obsolete reserve */
export const KAMINO_LENDING_ERROR__OBLIGATION_IN_OBSOLETE_RESERVE = 0x17_c4; // 6084
/** ReferrerStateOwnerMismatch: Referrer state owner does not match the given signer */
export const KAMINO_LENDING_ERROR__REFERRER_STATE_OWNER_MISMATCH = 0x17_c5; // 6085
/** UserMetadataOwnerAlreadySet: User metadata owner is already set */
export const KAMINO_LENDING_ERROR__USER_METADATA_OWNER_ALREADY_SET = 0x17_c6; // 6086
/** CollateralNonLiquidatable: This collateral cannot be liquidated (LTV set to 0) */
export const KAMINO_LENDING_ERROR__COLLATERAL_NON_LIQUIDATABLE = 0x17_c7; // 6087
/** BorrowingDisabled: Borrowing is disabled */
export const KAMINO_LENDING_ERROR__BORROWING_DISABLED = 0x17_c8; // 6088
/** BorrowLimitExceeded: Cannot borrow above borrow limit */
export const KAMINO_LENDING_ERROR__BORROW_LIMIT_EXCEEDED = 0x17_c9; // 6089
/** DepositLimitExceeded: Cannot deposit above deposit limit */
export const KAMINO_LENDING_ERROR__DEPOSIT_LIMIT_EXCEEDED = 0x17_ca; // 6090
/** BorrowingDisabledOutsideElevationGroup: Reserve does not accept any new borrows outside elevation group */
export const KAMINO_LENDING_ERROR__BORROWING_DISABLED_OUTSIDE_ELEVATION_GROUP = 0x17_cb; // 6091
/** NetValueRemainingTooSmall: Net value remaining too small */
export const KAMINO_LENDING_ERROR__NET_VALUE_REMAINING_TOO_SMALL = 0x17_cc; // 6092
/** WorseLtvBlocked: Cannot get the obligation in a worse position */
export const KAMINO_LENDING_ERROR__WORSE_LTV_BLOCKED = 0x17_cd; // 6093
/** LiabilitiesBiggerThanAssets: Cannot have more liabilities than assets in a position */
export const KAMINO_LENDING_ERROR__LIABILITIES_BIGGER_THAN_ASSETS = 0x17_ce; // 6094
/** ReserveTokenBalanceMismatch: Reserve state and token account cannot drift */
export const KAMINO_LENDING_ERROR__RESERVE_TOKEN_BALANCE_MISMATCH = 0x17_cf; // 6095
/** ReserveVaultBalanceMismatch: Reserve token account has been unexpectedly modified */
export const KAMINO_LENDING_ERROR__RESERVE_VAULT_BALANCE_MISMATCH = 0x17_d0; // 6096
/** ReserveAccountingMismatch: Reserve internal state accounting has been unexpectedly modified */
export const KAMINO_LENDING_ERROR__RESERVE_ACCOUNTING_MISMATCH = 0x17_d1; // 6097
/** BorrowingAboveUtilizationRateDisabled: Borrowing above set utilization rate is disabled */
export const KAMINO_LENDING_ERROR__BORROWING_ABOVE_UTILIZATION_RATE_DISABLED = 0x17_d2; // 6098
/** LiquidationBorrowFactorPriority: Liquidation must prioritize the debt with the highest borrow factor */
export const KAMINO_LENDING_ERROR__LIQUIDATION_BORROW_FACTOR_PRIORITY = 0x17_d3; // 6099
/** LiquidationLowestLiquidationLtvPriority: Liquidation must prioritize the collateral with the lowest liquidation LTV */
export const KAMINO_LENDING_ERROR__LIQUIDATION_LOWEST_LIQUIDATION_LTV_PRIORITY = 0x17_d4; // 6100
/** ElevationGroupBorrowLimitExceeded: Elevation group borrow limit exceeded */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_BORROW_LIMIT_EXCEEDED = 0x17_d5; // 6101
/** ElevationGroupWithoutDebtReserve: The elevation group does not have a debt reserve defined */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_WITHOUT_DEBT_RESERVE = 0x17_d6; // 6102
/** ElevationGroupMaxCollateralReserveZero: The elevation group does not allow any collateral reserves */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_MAX_COLLATERAL_RESERVE_ZERO = 0x17_d7; // 6103
/** ElevationGroupHasAnotherDebtReserve: In elevation group attempt to borrow from a reserve that is not the debt reserve */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_HAS_ANOTHER_DEBT_RESERVE = 0x17_d8; // 6104
/** ElevationGroupDebtReserveAsCollateral: The elevation group's debt reserve cannot be used as a collateral reserve */
export const KAMINO_LENDING_ERROR__ELEVATION_GROUP_DEBT_RESERVE_AS_COLLATERAL = 0x17_d9; // 6105
...
export const KAMINO_LENDING_ERROR__OBLIGATION_COLLATERAL_EXCEEDS_ELEVATION_GROUP_LIMIT = 0x17_da; // 6106
/** ObligationElevationGroupMultipleDebtReserve: Obligation is an elevation group but have more than one debt reserve */
export const KAMINO_LENDING_ERROR__OBLIGATION_ELEVATION_GROUP_MULTIPLE_DEBT_RESERVE = 0x17_db; // 6107
/** UnsupportedTokenExtension: Mint has a token (2022) extension that is not supported */
export const KAMINO_LENDING_ERROR__UNSUPPORTED_TOKEN_EXTENSION = 0x17_dc; // 6108
/** InvalidTokenAccount: Can't have an spl token mint with a t22 account */
export const KAMINO_LENDING_ERROR__INVALID_TOKEN_ACCOUNT = 0x17_dd; // 6109
/** DepositDisabledOutsideElevationGroup: Can't deposit into this reserve outside elevation group */
export const KAMINO_LENDING_ERROR__DEPOSIT_DISABLED_OUTSIDE_ELEVATION_GROUP = 0x17_de; // 6110
/** CannotCalculateReferralAmountDueToSlotsMismatch: Cannot calculate referral amount due to slots mismatch */
export const KAMINO_LENDING_ERROR__CANNOT_CALCULATE_REFERRAL_AMOUNT_DUE_TO_SLOTS_MISMATCH = 0x17_df; // 6111
/** ObligationOwnersMustMatch: Obligation owners must match */
export const KAMINO_LENDING_ERROR__OBLIGATION_OWNERS_MUST_MATCH = 0x17_e0; // 6112
/** ObligationsMustMatch: Obligations must match */
export const KAMINO_LENDING_ERROR__OBLIGATIONS_MUST_MATCH = 0x17_e1; // 6113
/** LendingMarketsMustMatch: Lending markets must match */
export const KAMINO_LENDING_ERROR__LENDING_MARKETS_MUST_MATCH = 0x17_e2; // 6114
/** ObligationCurrentlyMarkedForDeleveraging: Obligation is already marked for deleveraging */
export const KAMINO_LENDING_ERROR__OBLIGATION_CURRENTLY_MARKED_FOR_DELEVERAGING = 0x17_e3; // 6115
/** MaximumWithdrawValueZero: Maximum withdrawable value of this collateral is zero, LTV needs improved */
export const KAMINO_LENDING_ERROR__MAXIMUM_WITHDRAW_VALUE_ZERO = 0x17_e4; // 6116
/** ZeroMaxLtvAssetsInDeposits: No max LTV 0 assets allowed in deposits for repay and withdraw */
export const KAMINO_LENDING_ERROR__ZERO_MAX_LTV_ASSETS_IN_DEPOSITS = 0x17_e5; // 6117
/** LowestLtvAssetsPriority: Withdrawing must prioritize the collateral with the lowest reserve max-LTV */
export const KAMINO_LENDING_ERROR__LOWEST_LTV_ASSETS_PRIORITY = 0x17_e6; // 6118
/** WorseLtvThanUnhealthyLtv: Cannot get the obligation liquidatable */
export const KAMINO_LENDING_ERROR__WORSE_LTV_THAN_UNHEALTHY_LTV = 0x17_e7; // 6119
/** FarmAccountsMissing: Farm accounts to refresh are missing */
export const KAMINO_LENDING_ERROR__FARM_ACCOUNTS_MISSING = 0x17_e8; // 6120
/** RepayTooSmallForFullLiquidation: Repay amount is too small to satisfy the mandatory full liquidation */
export const KAMINO_LENDING_ERROR__REPAY_TOO_SMALL_FOR_FULL_LIQUIDATION = 0x17_e9; // 6121
/** InsufficientRepayAmount: Liquidator provided repay amount lower than required by liquidation rules */
export const KAMINO_LENDING_ERROR__INSUFFICIENT_REPAY_AMOUNT = 0x17_ea; // 6122
/** OrderIndexOutOfBounds: Obligation order of the given index cannot exist */
export const KAMINO_LENDING_ERROR__ORDER_INDEX_OUT_OF_BOUNDS = 0x17_eb; // 6123
/** InvalidOrderConfiguration: Given order configuration has wrong parameters */
export const KAMINO_LENDING_ERROR__INVALID_ORDER_CONFIGURATION = 0x17_ec; // 6124
...
export const KAMINO_LENDING_ERROR__ORDER_CONFIGURATION_NOT_SUPPORTED_BY_OBLIGATION = 0x17_ed; // 6125
...
export const KAMINO_LENDING_ERROR__OPERATION_NOT_PERMITTED_WITH_CURRENT_OBLIGATION_ORDERS = 0x17_ee; // 6126
/** OperationNotPermittedMarketImmutable: Cannot update lending market because it is set as immutable */
export const KAMINO_LENDING_ERROR__OPERATION_NOT_PERMITTED_MARKET_IMMUTABLE = 0x17_ef; // 6127
/** OrderCreationDisabled: Creation of new orders is disabled */
export const KAMINO_LENDING_ERROR__ORDER_CREATION_DISABLED = 0x17_f0; // 6128
/** NoUpgradeAuthority: Cannot initialize global config because there is no upgrade authority to the program */
export const KAMINO_LENDING_ERROR__NO_UPGRADE_AUTHORITY = 0x17_f1; // 6129
