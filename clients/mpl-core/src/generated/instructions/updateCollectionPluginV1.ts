...
export function getUpdateCollectionPluginV1DiscriminatorBytes(): ReadonlyUint8Array {
...
export interface UpdateCollectionPluginV1InstructionData {
  discriminator: number;
  updateCollectionPluginV1Args: UpdateCollectionPluginV1Args;
}

export interface UpdateCollectionPluginV1InstructionDataArgs {
...
export function getUpdateCollectionPluginV1InstructionDataDecoder(): Decoder<UpdateCollectionPluginV1InstructionData> {
  return getStructDecoder([
    ...
    ["updateCollectionPluginV1Args", getUpdateCollectionPluginV1ArgsDecoder()],
  ]);
}
...
export interface UpdateCollectionPluginV1Input<
...
> {
  ...
  updateCollectionPluginV1Args: UpdateCollectionPluginV1InstructionDataArgs["updateCollectionPluginV1Args"];
}
...
export interface ParsedUpdateCollectionPluginV1Instruction<
  TProgram extends string = typeof MPL_CORE_PROGRAM_PROGRAM_ADDRESS,
