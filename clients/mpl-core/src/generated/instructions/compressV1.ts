...
export function getCompressV1DiscriminatorBytes(): ReadonlyUint8Array {
...
export function getCompressV1InstructionDataEncoder(): FixedSizeEncoder<CompressV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["compressV1Args", getCompressV1ArgsEncoder()],
    ]),
...
export function getCompressV1InstructionDataDecoder(): FixedSizeDecoder<CompressV1InstructionData> {
  return getStructDecoder([
    ...
    ["compressV1Args", getCompressV1ArgsDecoder()],
  ]);
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getCompressV1InstructionDataEncoder().encode(
      args as CompressV1InstructionDataArgs,
    ),
    programAddress,
