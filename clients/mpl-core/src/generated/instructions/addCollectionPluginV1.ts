...
export function getAddCollectionPluginV1DiscriminatorBytes(): ReadonlyUint8Array {
...
export function getAddCollectionPluginV1InstructionDataEncoder(): Encoder<AddCollectionPluginV1InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["addCollectionPluginV1Args", getAddCollectionPluginV1ArgsEncoder()],
    ]),
    (value) => ({
      ...value,
...
export function getAddCollectionPluginV1InstructionDataDecoder(): Decoder<AddCollectionPluginV1InstructionData> {
  return getStructDecoder([
    ...
    ["addCollectionPluginV1Args", getAddCollectionPluginV1ArgsDecoder()],
  ]);
}
