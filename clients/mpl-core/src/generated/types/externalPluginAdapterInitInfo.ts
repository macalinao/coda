...
export type ExternalPluginAdapterInitInfo =
  ...
  | { __kind: "AgentIdentity"; fields: readonly [AgentIdentityInitInfo] };
...
export type ExternalPluginAdapterInitInfoArgs =
  ...
  | { __kind: "AgentIdentity"; fields: readonly [AgentIdentityInitInfoArgs] };
...
export function getExternalPluginAdapterInitInfoEncoder(): Encoder<ExternalPluginAdapterInitInfoArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "AgentIdentity",
      getStructEncoder([
        ["fields", getTupleEncoder([getAgentIdentityInitInfoEncoder()])],
      ]),
    ],
  ]);
}
...
export function getExternalPluginAdapterInitInfoDecoder(): Decoder<ExternalPluginAdapterInitInfo> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "AgentIdentity",
      getStructDecoder([
        ["fields", getTupleDecoder([getAgentIdentityInitInfoDecoder()])],
      ]),
    ],
  ]);
}
