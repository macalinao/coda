...
export type ExternalPluginAdapterUpdateInfo =
  ...
  | { __kind: "AgentIdentity"; fields: readonly [AgentIdentityUpdateInfo] };
...
export type ExternalPluginAdapterUpdateInfoArgs =
  ...
  | { __kind: "AgentIdentity"; fields: readonly [AgentIdentityUpdateInfoArgs] };
...
export function getExternalPluginAdapterUpdateInfoEncoder(): Encoder<ExternalPluginAdapterUpdateInfoArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "AgentIdentity",
      getStructEncoder([
        ["fields", getTupleEncoder([getAgentIdentityUpdateInfoEncoder()])],
      ]),
    ],
  ]);
}
...
export function getExternalPluginAdapterUpdateInfoDecoder(): Decoder<ExternalPluginAdapterUpdateInfo> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "AgentIdentity",
      getStructDecoder([
        ["fields", getTupleDecoder([getAgentIdentityUpdateInfoDecoder()])],
      ]),
    ],
  ]);
}
