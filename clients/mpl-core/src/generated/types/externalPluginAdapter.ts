...
export type ExternalPluginAdapter =
  ...
  | { __kind: "AgentIdentity"; fields: readonly [AgentIdentity] };
...
export type ExternalPluginAdapterArgs =
  ...
  | { __kind: "AgentIdentity"; fields: readonly [AgentIdentityArgs] };
...
export function getExternalPluginAdapterEncoder(): Encoder<ExternalPluginAdapterArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "AgentIdentity",
      getStructEncoder([
        ["fields", getTupleEncoder([getAgentIdentityEncoder()])],
      ]),
    ],
  ]);
}
...
export function getExternalPluginAdapterDecoder(): Decoder<ExternalPluginAdapter> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "AgentIdentity",
      getStructDecoder([
        ["fields", getTupleDecoder([getAgentIdentityDecoder()])],
      ]),
    ],
  ]);
}
