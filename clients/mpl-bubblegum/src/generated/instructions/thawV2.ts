...
export function getThawV2DiscriminatorBytes(): ReadonlyUint8Array {
...
export interface ThawV2InstructionData {
...
export interface ThawV2InstructionDataArgs {
  root: number[];
  dataHash: number[];
  creatorHash: number[];
...
export interface ParsedThawV2Instruction<
  TProgram extends string = typeof BUBBLEGUM_PROGRAM_ADDRESS,
