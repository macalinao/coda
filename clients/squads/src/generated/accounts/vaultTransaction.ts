...
/** Gets the encoder for {@link VaultTransactionArgs} account data. */
...
/** Gets the decoder for {@link VaultTransaction} account data. */
...
/** Gets the codec for {@link VaultTransaction} account data. */
...
export async function fetchVaultTransactionFromSeeds(
  rpc: Parameters<typeof fetchEncodedAccount>[0],
  seeds: TransactionSeeds,
  config: FetchAccountConfig & { programAddress?: Address } = {},
): Promise<Account<VaultTransaction>> {
  const maybeAccount = await fetchMaybeVaultTransactionFromSeeds(
    rpc,
    seeds,
    config,
  );
...
export async function fetchMaybeVaultTransactionFromSeeds(
  rpc: Parameters<typeof fetchEncodedAccount>[0],
  seeds: TransactionSeeds,
  config: FetchAccountConfig & { programAddress?: Address } = {},
): Promise<MaybeAccount<VaultTransaction>> {
  ...
  return await fetchMaybeVaultTransaction(rpc, address, fetchConfig);
}
