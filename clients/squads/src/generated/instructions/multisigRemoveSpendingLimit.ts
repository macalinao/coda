...
import {
  getMultisigRemoveSpendingLimitArgsDecoder,
  getMultisigRemoveSpendingLimitArgsEncoder,
  type MultisigRemoveSpendingLimitArgs,
  type MultisigRemoveSpendingLimitArgsArgs,
} from "../types/index.js";

export const MULTISIG_REMOVE_SPENDING_LIMIT_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([228, 198, 136, 111, 123, 4, 178, 113]);

export function getMultisigRemoveSpendingLimitDiscriminatorBytes(): ReadonlyUint8Array {
...
export type MultisigRemoveSpendingLimitInstructionDataArgs = {
  args: MultisigRemoveSpendingLimitArgsArgs;
};
...
export function getMultisigRemoveSpendingLimitInstructionDataEncoder(): Encoder<MultisigRemoveSpendingLimitInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["args", getMultisigRemoveSpendingLimitArgsEncoder()],
    ]),
    (value) => ({
      ...value,
...
export function getMultisigRemoveSpendingLimitInstructionDataDecoder(): Decoder<MultisigRemoveSpendingLimitInstructionData> {
  return getStructDecoder([
    ...
    ["args", getMultisigRemoveSpendingLimitArgsDecoder()],
  ]);
}
...
> = {
  ...
  args: MultisigRemoveSpendingLimitInstructionDataArgs["args"];
};
