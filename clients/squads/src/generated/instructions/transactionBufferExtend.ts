...
import {
  ...
  type TransactionBufferExtendArgs,
  type TransactionBufferExtendArgsArgs,
} from "../types/index.js";
...
export type TransactionBufferExtendInstructionDataArgs = {
  args: TransactionBufferExtendArgsArgs;
};
...
export function getTransactionBufferExtendInstructionDataEncoder(): Encoder<TransactionBufferExtendInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["args", getTransactionBufferExtendArgsEncoder()],
    ]),
    (value) => ({
      ...value,
...
export function getTransactionBufferExtendInstructionDataDecoder(): Decoder<TransactionBufferExtendInstructionData> {
  return getStructDecoder([
    ...
    ["args", getTransactionBufferExtendArgsDecoder()],
  ]);
}
...
> = {
  ...
  args: TransactionBufferExtendInstructionDataArgs["args"];
};
